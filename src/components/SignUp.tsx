...
class SignUp extends React.Component<{ path: string }, {}> {
  state = initialState;
  ...
  render() {
    return (
      <div>
        ...
        {this.state.stage === 0 && (
          <div style={styles.formContainer}>
            ...
            <input
              ...
              style={styles.input}
            />
            <input onChange={this.handleUpdate} placeholder="Email" name="email" value={this.state.email} style={styles.input} />
            <input
              onChange={this.handleUpdate}
        ...
        <Link to="/harta/login">Sign In</Link>
      </div>
    );
  }
}
