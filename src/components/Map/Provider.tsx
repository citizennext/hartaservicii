        ...
        <section className="map-marker-popup-single">
          ...
          <footer className="grid md:grid-cols-2">
            ...
            <div className="p-6 md:p-12 border-b border-brown md:border-0">
              ...
              <Link to="administrare/nevoi-covid" className="btn btn-celeste btn-full mt-4 md:ml-0">
              ...
              <a
                ...
                className="btn btn-celeste btn-full mt-4 md:ml-0">
                Contactează-ne
              </a>
            </div>
            <div className="p-6 md:p-12 border-b border-brown">
              ...
              <ul className="font-body italic">
                {providers.rating_aggregate.nodes.map(
                  (testimonial: { id: string; rating: number; feedback: string; user: { username: string } }) => {
                    return (
                      <li key={testimonial.id} className="py-2 border-b border-brown">
